--[[
  ...
  MJL20170220 - imported from https://github.com/asharpe/dotfiles/blob/master/link/.hammerspoon/jumpcut.lua

  I think originally this came from
  https://github.com/VFS/.hammerspoon/blob/master/tools/clipboard.lua

  Small changes between VFS and ASharpe:

   - honor_clearcontent = true
   - jumpcut=hs.menubar.new(false) instead of local jumpcut ... new()
