...
if not defined? VagrantPlugins::DockerProvisioner::Cap::Debian::DockerInstall
	require "vagrant"
	require "#{Vagrant.source_root}/plugins/provisioners/docker/cap/debian/docker_install"
end
